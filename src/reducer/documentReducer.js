...
//initialState used to be defined in reducer only but in this case we have defined initial state for all in intialstate.json 
//file and importing required things from it as .document 
