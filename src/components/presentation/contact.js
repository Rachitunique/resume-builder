...
function Contact(props) {
   ...
   //agar mere pass id ya skin ya document nhi hai to wapas skin wale page pe chale jao 
   useEffect(() => {
  ...
  const onchange=(event)=>{
    ...
    //form submit hone pe sara data store me add karna hai object ke form me aur education wale page pe chale jana hai
          ...
          <div className="container med contact">
            <div className="section funnel-section">
                <div className="form-card">
                    ...
                    <div className="form-section">
                        <div className="input-group"><label>First Name</label>
                            {/*value ke ander pass kiya hai ki agar mai update karne ke liye aaya hu to meri fields pahle se bhari honi chahiye 
                            to usi ke liye value pass kari hai getFieldData upar defined kiya hai function*/}
                ...
                <div className="preview-card">
                    {/*ab resume preview ko props ki zarurat nhi hai*/}
...
const mapStateToProps= (state)=>{
    return {
        ...
        //ye use state me ise use kiya hai isliye ise mangwaya
